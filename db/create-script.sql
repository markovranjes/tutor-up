...
-- -----------------------------------------------------
-- Table `tutor-up`.`Study`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tutor-up`.`Study` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tutor-up`.`Tutor` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Tutor_Study1_idx` (`Study_id` ASC) VISIBLE,
  CONSTRAINT `fk_Tutor_Study1`
    FOREIGN KEY (`Study_id`)
    REFERENCES `tutor-up`.`Study` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tutor-up`.`Student` (
  ...
  `Study_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Student_Study1_idx` (`Study_id` ASC) VISIBLE,
